...
E assim por diante para cada tipo de nó. O raciocínio e ideia por trás é de que `GenericVisitor` é um **template**. Criamos _visitors_ concretos herdando desta classe e redefinindo apenas o necessário.
